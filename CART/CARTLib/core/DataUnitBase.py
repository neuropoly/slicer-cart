...
class ResourceType(Protocol):
    ...
    def generate_user_warning(self, uid: str, resource_name: str = "") -> Optional[str]:
        """
        Optionally generate a warning that should be displayed to the user
        when they select this resource type. A common use case is showing the
        user how the resource's name will be used to generate a subject's output.
